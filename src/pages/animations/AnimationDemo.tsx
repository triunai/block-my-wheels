      ...
      <div className="relative z-10 p-8">
        ...
        <RevealOnScroll className="mb-16">
          <div className="bg-black/20 backdrop-blur-sm rounded-lg p-6 border border-white/10 text-center">
            <h2 className="text-2xl font-semibold mb-4">🚀 Epic Demos</h2>
            <p className="text-gray-300 mb-4">
              Check out our amazing demos with advanced animations!
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <FloatingElement intensity={10} speed={1.5}>
                <motion.button
                  className="bg-gradient-to-r from-purple-500 to-blue-500 text-white px-8 py-4 rounded-full font-semibold text-lg shadow-lg"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
